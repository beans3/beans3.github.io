...
실습 환경 : Colaboratory   
- Colab 사용 장점  
-1. Google 자원 사용, 업데이트 자동, 실습, 코드 공유, 설치, 환경설정 쉬움  
-2. 단, 맨 마지막 문장만 출력되기 때문에 중간 문장을 출력하고 싶다면 print() 사용  
(단, 본문 안에 편의상 print()를 사용하지 않아도 출력 결과를 적어두었습니다.)  
-3. Colab에서 실습할 때, 실행시 메모리에 할당됩니다. 실행을 잊지 마세요!  
(Ctrl + Enter/실행 버튼 클릭)  
...
df
```  
> ![pdtable](https://github.com/beans3/beans3.github.io/tree/master/imgs/pdtable.jpg)  
...
df[["a","b"]]
```  
> ![pdtable2](https://github.com/beans3/beans3.github.io/tree/master/imgs/pdtable2.jpg)  
